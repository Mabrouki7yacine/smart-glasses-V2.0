...
void app_main(void) {
	...
	ssd1306_display_text(&dev, 4, "   time 15", 9, false);
	//here's our main function
    while (1) {
		menu_changed = 0;
    	switch (menu) {
    	    case home_page:
                get_request("http://192.168.186.87:5000/home");
    	    ...
    	    case face_rec:
                get_request("http://192.168.186.87:5000/face_rec");
			...
			case text_trans:
                get_request("http://192.168.186.87:5000/translation");
    		...
    		case AI_helper:
                get_request("http://192.168.186.87:5000/AI_assistant");
                textwrapped *dis_txt;
    		    dis_txt = wrp(data);
